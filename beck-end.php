    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ">
                    <li class="nav-item">
                        <a class="nav-link active" href="Home.html" target="_blank">home</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 kanan-jumbo">
                    <img src="img/Data and settings_Two Color.png" width="300px">
                </div>
            </div>
        </div>
            ...
            <div class="row mt-5">
                <div class="col-md-8">
                    <div class="card mb-3" style="width: 30rem;">
                        ...
                        <div class="card-body">
                            <a href="isi.php?id=4"><p class="card-text">PHP</p></a>
                        </div>
                    </div>
                    <div class="card mb-3" style="width: 30rem;">
                        <img src="img/1.png" class="card-img-top" width="100px" alt="projects-1">
                        <div class="card-body">
                            <a href="isi.php?id=5"><p class="card-text">LARAVEL</p></a>
                        </div>
                    </div>
                    <div class="card mb-3" style="width: 30rem;">
                        <img src="img/1.png" class="card-img-top" width="100px" alt="projects-1">
                        <div class="card-body">
                            <a href="isi.php?id=6"><p class="card-text">Codeigneter</p></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
